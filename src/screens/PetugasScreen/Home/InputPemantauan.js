...
export default function InputPemantauan({ navigation, route }) {
        ...
        <View style={{ flex: 1, alignSelf: "center", width: "90%" }}>
          ...
          <View style={{ flex: 1 }}>
            <PrimaryButton
              ...
              disabled={
                !(selectedVideo && description && (data.status == "belum" || data.status == 'tolak'))
              }
            />
          </View>
        </View>
