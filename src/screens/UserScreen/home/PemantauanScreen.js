...
export default function PemantauanScreen({ navigation }) {
  ...
  const fetchData = async () => {
    try {
      ...
      hasil = data.anak
      filterAnak = hasil.filter((item) => item.masyarakat_id == userData.masyarakat.id)
      filterBantuan = filterAnak.filter((bantuan) => bantuan.isBantuan == '1')
